# Projeto de Banco de Dados de E-commerce (Conceitual e Lógico)

## Definição do escopo

A base de dados possui os seguintes elementos:

- Produto: Itens a serem comercializados.
- Estoque: Local e quantidade de cada item.
- Cliente: Quem fará a compra, pode ser uma pessoa física ou jurídica.
- Pedido: São criados pelos clientes. Pode possuir um ou mais produtos.
- Fornecedor: Origem dos produtos.


Para refinar o projeto foram criadas as seguintes estruturas:

- Pessoa Física
- Pessoa Jurídica
- Endereço

Um cliente é uma pessoa física ou uma pessoa jurídica.
Uma pessoa jurídica, pode ser um cliente, mas também pode um parceiro de vendas, fornecendo produtos.
Endereço agrupa as informações de localização de todas entidades. Um produto é estocado em um endereço. E um pedido possui endereços de origem e destino, que serão utilizados para o cálculo do frete.

O diagrama do projeto do banco de dados é apresentado a seguir:

![](png/diagrama_EER.png)
